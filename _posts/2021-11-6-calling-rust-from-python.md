...
The examples from this post can be found [here](https://github.com/saidvandeklundert/rust_from_python).
    
Note: when creating this post, I used CPython 3.9.2, Pydantic version `1.8.2` and Rust 1.56.0.
